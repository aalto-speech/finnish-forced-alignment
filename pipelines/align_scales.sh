...
steps/nnet3/align.sh --nj 1 --use_gpu false --scale_opts "--transition-scale=1.0 --acoustic-scale=1.0 --self-loop-scale=1.0" --online_ivector_dir exp/align/ivectors_hires data/align_hires/ data/lang/ exp/nnet3/chain/ exp/align_ali
